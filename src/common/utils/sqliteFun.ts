...
export const createTable = (type: 'chain'| 'asset' |'wallet'| 'walletAsset'|'account'|'accountAsset') =>{
	const TABLE_MAP = {
...
export const insertOrReplaceTableData = async (tableName: 'asset'| 'wallet'|'walletAsset'|'account'|'accountAsset', value: Record<string, any>) => {
	const table_map = {
		asset: INIT_ASSET,
		wallet: INIT_WALLET,
